# python-eda-projects
Este repositório reúne projetos de **Análise Exploratória de Dados (EDA)** desenvolvidos em **Python**, com o objetivo de demonstrar minhas habilidades em análise, visualização e interpretação de dados.

---

## 👨‍💻 Sobre mim
Formação em Engenharia da Computação, com interesse em transformar dados em insights por meio de estatística, visualização e pensamento analítico.
...
### 🔹 EDA – Netflix Top 10
- Análise descritiva de títulos mais assistidos
